...
namespace ProjectManagementSystem
{
    class ProjectApp
    {
        static void Main(string[] args)
        {
            ...
            string connectionString = "Data Source=DESKTOP-5VEHB15;Initial Catalog=PMSystem;Integrated Security=True;TrustServerCertificate=True"; // Replace with your actual connection string
            IProjectRepository projectRepository = new ProjectRepositoryImpl(connectionString);
        ...
        private static void AddEmployee(IProjectRepository projectRepository)
        {
            try
            {
                Console.WriteLine("\n--- Add Employee ---");
        ...
        private static void AddProject(IProjectRepository projectRepository)
        {
            try
            {
                Console.WriteLine("\n--- Add Project ---");
        ...
        private static void AddTaskToProject(IProjectRepository projectRepository)
        {
            try
            {
                Console.WriteLine("\n--- Add Task to Project ---");
        ...
        private static void AssignProjectToEmployee(IProjectRepository projectRepository)
        {
            try
            {
        ...
        private static void AssignTaskToEmployeeInProject(IProjectRepository projectRepository)
        {
            try
            {
        ...
        private static void DeleteEmployee(IProjectRepository projectRepository)
        {
            try
            {
                Console.WriteLine("\n--- Delete Employee ---");
        ...
        private static void DeleteProject(IProjectRepository projectRepository)
        {
            try
            {
                Console.WriteLine("\n--- Delete Project ---");
        ...
        private static void ListTasksForEmployeeInProject(IProjectRepository projectRepository)
        {
            try
            {
